  ...
  <v-container>
    <v-row>
        ...
        <v-card rounded="lg" elevation="5">
          <v-card-text class="text-center">
            ...
            <v-btn
              ...
              class="mt-2 text-capitalize text-blue"
              flat
            >
              Update profile
          ...
          <v-card-subtitle
            v-if="profile.user?.phone != undefined"
          ...
          <v-card-subtitle
            v-if="profile.user?.address != undefined"
            class="font-weight-bold"
      ...
      <v-col cols="12" sm="9">
        ...
        <v-row v-else dense>
          <v-col
            v-for="(good, i) in shoplisting.myGoods"
            :key="i"
            cols="12"
            sm="6"
            md="4"
